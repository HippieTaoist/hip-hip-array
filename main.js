...
for (const studeNum of students) {
    console.log(studeNum);
}
/////// My Bad Code //////
// for (count = 0; count < students.length; count++) {
//     document.writeIn((count + 1) + ": " + students[count]);
// }
...
// // Challenge 2  ////Completed with Alt solution than presented.. slightly
// // Loop through the following array BACKWARDS, console.logging out each value. 64 should be printed first and 100 last.
const grades = [100, 80, 110, 75, 83, 64];
let gradesReverse = grades.slice(0).reverse();
